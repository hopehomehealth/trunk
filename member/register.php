...
if($g_config['mobile_domain'] == $g_http_host){  
	include(dirname(__FILE__).'/register.mobile.php');
	exit();
}  
?>
<!DOCTYPE html>
		...
		<div class="log_big"> 
			<div class="registered "> 
				<ul class="registered_nav clear">
					<li class="on">用户注册 <span></span>
					</li> 
				</ul>
				 
				<div class="membership mgw_card" id="registerInputDiv">

					<form id="registerForm" action="do.passport?ac=register" method="post" onsubmit="return checkForm(this)">    
 
						<div class="form_line">
							<label for="mobileNo"><span>*</span>用户名</label> <input name="username" id="mobileNo" 
						...
						<div class="form_line">
							<label for="password"><span>*</span>设置密码</label> 
						...
						<div class="form_line">
							<label for="password"><span>*</span>确认密码</label> <input name="repassword" id="repassword" 
						...
						<div id="mobileCodeInput" class="verification_code_phone" style="display:none">
							...
							<div class="resend" onclick="send_sms()">发送验证码</div>
						</div>  
 
						<input id="btn_submit" type="submit" value="注册" class="members_submit" />
