...
<section class="signup"> <a href="/" class="logo"></a>
	<ul class="Nav-tab">
		<li class="on"><a href="javascript:void(0)">找回密码</a></li>
	</ul>
	<form action="do.passport?ac=register" method="post" id="registerForm" target="frm"> 
		<ul class="forms">
			...
			<li>
				<input name="password" type="password" class="input" placeholder="输入新的密码..." autocomplete="off" value="">
			</li>
			<li>
				<input name="repassword" type="password" class="input" placeholder="再次确认您的新密码..." autocomplete="off" value="">
			</li>
		</ul> 
		<div class="btns">
