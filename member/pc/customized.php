...
<div style="font-size:14px;line-height:1.9;">
	<form action="/member/do?ac=customized" method="post" >
		<table >
			<tr>
			  <td>&nbsp;</td>
			  <td><h4>私人定制</h4> 如有疑问，请致电咨询：<b style="color:red"><?=$g_profile['hot_line']?></b>  </td>
			</tr>
			<tr>
			  <td width="120"><font color="red">*</font>出发城市：</td>
			  <td><input type="text" id="start_city" name="start_city" value="" required />
				<span id="start_city_notice"> </span></td>
			</tr>
			<tr>
			  <td><font color="red">*</font>目的地：</td>
			  <td><div>
				  <textarea id="destination" name="destination" autocomplete="off" required></textarea>
				  <span id="destination_notice"> </span></div></td>
			</tr>
			<tr>
			  <td><font color="red">*</font>拟出发日期：</td>
			  <td><input type="date" placeholder="最早出发日期" id="begin_start_date" name="begin_start_date"  value="<?=date('Y-m-d')?>" required/>
				~
				<input type="date" placeholder="最晚出发日期" id="last_start_date" name="last_start_date" value="<?=date('Y-m-d')?>" required/>
				<span id="date_notice"> </span></td>
			</tr>
			<tr>
			  <td><font color="red">*</font>拟行程天数：</td>
			  <td><input type="text" id="duration_min" name="duration_min" class="span2" required/>
				天~
				<input type="text" id="duration_max" name="duration_max" class="span2" required/>
				天<span id="duration_notice"> </span></td>
			</tr>
			<tr>
			  <td><font color="red">*</font>拟出游人数：</td>
			  <td><input type="text" id="tourist_num_min" name="tourist_num_min" class="span2" required/>
				人~
				<input type="text" id="tourist_num_max" name="tourist_num_max" class="span2" required/>
			...
			<tr>
			  ...
			  <td><input id="linker" name="linker" type="text" required/>
