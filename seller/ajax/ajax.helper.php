<? 
if($_COOKIE['CLOOTA_B2B2C_SHOP_UUID'] != '' && $_GET['action']=='goods_detail_edit'){  
?>   
...
<? 
if($_COOKIE['CLOOTA_B2B2C_SHOP_UUID'] != '' && $_GET['action']=='goods_catalog_edit'){  
?>   
...
<? 
if($_COOKIE['CLOOTA_B2B2C_SHOP_UUID'] != '' && $_GET['action']=='goods_detail_add'){  
?>   
