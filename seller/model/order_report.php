...
$sql = "SELECT * FROM t_user_order a WHERE a.`site_id`='$g_siteid' AND a.`state`='4' AND a.`shop_id`='$g_shopid' $qer ORDER BY a.`order_code` DESC ";   
