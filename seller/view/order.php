...
<div class="bar_title">
	<strong>订单管理 (<?=$g_order_state[req('state')]?>)</strong>
...
<form name="q_from" method="GET" action="./" class="form-inline" target="_top">  
	...
	<input name="kw" type="text" id="kw" class="span4" value="<?=req('kw')?>" placeholder="输入订单号、商家、产品关键词…"/>  
...
<?if(notnull($query_rows)){?>
	<table width="100%" class="table table-condensed" style="font-size:12px">  
		<tr> 
			...
			<td width="70"><strong>下单时间</strong></td>
