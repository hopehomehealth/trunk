        ...
        <div class="m-list"> <a href="<?=$g_domain?>product/detail-<?=$val['goods_id']?>.html">
          ...
          <div class="m-c">
            <div class="m-c-bg">
              ...
              <p class="m-c-txt"> <span><em class="c-1"><?=$g_product_type[$val['goods_type']]?></em></span> <?if($val['goods_package']!='0'){?><span><em class="c-3"><?=str_replace('套餐','',$g_product_package[$val['goods_package']])?></em></span><?}?> <strong><?=$val['min_price']?><em class="co-1">元起</em></strong> </p>
            </div>
          </div>
          </a> </div>
		<?
