(function(j, f, c, i, d, l, g) {
    ...
    var b = j.$Jssor$ = new function() {
        var h = this, Ab = /\S+/g, K = 1, ib = 2, mb = 3, lb = 4, qb = 5, L, s = 0, k = 0, t = 0, z = 0, A = 0, D = navigator, vb = D.appName, o = D.userAgent, y = f.documentElement, q = parseFloat;
        function Ib() {
            if (!L) {
                L = {
                ...
                if (D.pointerEnabled || (a = D.msPointerEnabled))
                    L.Md = a ? "msTouchAction" : "touchAction"
            }
            return L
        }
        function v(h) {
        ...
        function O(d, a) {
            ...
            if (a) {
                ...
                if (H()) {
                    if (a.$TranslateX || a.$TranslateY || a.$TranslateZ != g)
        ...
        h.Wg = function(d, a) {
            if (a)
                d.style.clip = "rect(" + c.round(a.$Top || a.I || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.D || 0) + "px)";
            else if (a !== g) {
        ...
        ;
        h.wc = function(a) {
            h.Ag(h.$Children(a, d), a)
        }
        ;
        h.zg = function(a, b) {
            var c = h.Wd(a);
            b & 1 && h.z(a, (h.$CssWidth(c) - h.$CssWidth(a)) / 2);
            b & 2 && h.B(a, (h.$CssHeight(c) - h.$CssHeight(a)) / 2)
        }
        ;
        h.ac = function(b, a) {
        ...
        function w(f, l) {
            ...
            function a(d, a) {
                ...
                if (b) {
                    ...
                    if (a.$OriginalWidth)
                        i = k(c, a.$OriginalWidth, a.$OriginalHeight);
                    h.yd(d, i.y);
                    h.xd(d, i.x);
                    o = c.se();
        ...
        h.jd = function(l, m, x, q, z, A, n) {
            ...
            if (a.$Clip && b.Vg() && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.I && !a.$Clip.D && a.$Clip.$Right == n.$OriginalWidth && a.$Clip.$Bottom == n.$OriginalHeight)
                a.$Clip = i;
            return a
        }
    }
    ...
    var p = j.$JssorSlideshowFormations$ = new function() {
        ...
        h.$FormationStraight = function(f) {
            for (var d = f.$Cols, e = f.$Rows, s = f.$Assembly, t = f.Nb, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t - 1, c, b = 0; b < e; b++)
                for (a = 0; a < d; a++) {
                    switch (s) {
                    case j:
                        c = h - (a * e + (q - b));
    ...
    j.$JssorSlideshowRunner$ = function(k, s, q, u, z) {
        ...
        ;
        if (b.Ob() || b.$IsBrowserOpera() || z && b.$WebKitVersion() < 537)
            h = 16;
        n.call(f);
        m.call(f, -1e7, 1e7)
    }
    ...
    var k = j.$JssorSlider$ = function(p, hc) {
        ...
        function Bc(j, f) {
            ...
            function E(a) {
                ...
                T(j, a, 0);
                F = d;
                q = new I.$Class(j,I,b.mg(b.$AttributeEx(j, "idle")) || qc);
                q.E(0)
            }
            function Y() {
                q.Cc < I.Cc && E()
            ...
            e.Hb = function(c, a) {
                ...
                if (y.length && !H) {
                    ...
                    b.Pg(y, o, b.$CreateCallback(i, O, c, a))
                } else
                    O(c, a)
            }
            ;
                ...
                if (d != f) {
                    if (A) {
                        ...
                        if (g) {
                            var k = R = b.N()
                              , h = C[t(d)];
                            return h.Hb(b.$CreateCallback(i, X, d, h, g, k), x)
                        }
                    }
                    ob(d)
                } else if (a.$Loop) {
            ...
            function T(a, c, e) {
                ...
                b.$Each(f, function(f) {
                    ...
                    if (i == "caption") {
                        if (c) {
                            b.Nc(f, b.$AttributeEx(f, "to"));
                            b.Yf(f, b.$AttributeEx(f, "bf"));
                            b.$AttributeEx(f, "3d") && b.Xf(f, "preserve-3d")
            ...
            e.jb = f;
            n.call(e);
            b.Zf(j, b.$AttributeEx(j, "p"));
            b.bg(j, b.$AttributeEx(j, "po"));
            var N = b.$FindChild(j, "thumb", d);
            if (N) {
                e.ug = b.$CloneNode(N);
                b.O(N)
            }
        ...
        function zc(y, f, p, q) {
            ...
            function v() {
                b.wc(N);
                fc && j && o.gd && b.$AppendChild(N, o.gd);
                b.u(N, !j && o.Lb)
            }
            function w() {
                a.kc()
        ...
        function ac(a, c) {
            a = b.Kd(a);
            var j = b.$EvtSrc(a);
            if (!L && !b.$AttributeEx(j, "nodrag") && wc() && (!c || a.touches.length == 1)) {
                B = d;
                Ab = l;
                R = i;
        ...
        function Gb(c, d) {
            ...
            b.$Each(Nb, function(a) {
                var c = b.ac(b.$AttributeEx(a, "autocenter"));
                b.zg(a, c)
            })
        }
        ...
        if (r) {
            ...
            var xb = v, C = [], A, N, Fb = b.$Device(), kb = Fb.Rf, G, qb, Kb, tb;
            Fb.Md && b.$Css(xb, Fb.Md, ([i, "pan-y", "pan-x", "none"])[Y] || "");
            U = new Dc;
            if (db)
                A = new sb(Vb,K,J,eb,kb);
            b.$AppendChild(ib, U.Qb);
            b.tb(v, "hidden");
            N = Zb();
            ...
            b.$AddEvent(p, "mouseout", b.cc(kc, p));
            b.$AddEvent(p, "mouseover", b.cc(jc, p));
            if (Y) {
        ...
        f.mc = function(E) {
            if (!u) {
                ...
                for (var f = 0; f < s; f++) {
                    ...
                    b.$AppendChild(e, l);
                    B[f] = l;
                    a.$ActionMode & 1 && b.$AddEvent(l, "click", b.$CreateCallback(i, t, f));
                    a.$ActionMode & 2 && b.$AddEvent(l, "mouseover", b.cc(b.$CreateCallback(i, t, f), l));
                    y[f] = b.bc(l)
                }
                u = d
            }
    ...
    j.$JssorArrowNavigator$ = function(a, g, h) {
        ...
        c.mc = function(c) {
            ...
            e = 0;
            if (!q) {
                b.$AddEvent(a, "click", b.$CreateCallback(i, k, -j));
                b.$AddEvent(g, "click", b.$CreateCallback(i, k, j));
                p = b.bc(a);
                m = b.bc(g);
                q = d
            }
    ...
    j.$JssorThumbnailNavigator$ = function(g, B) {
        ...
        function A(n, f) {
            ...
            g.jb = f;
            g.zd = q;
            l = n.ug || n.Lb || b.$CreateDiv();
            g.Qb = c = b.hd(j, "thumbnailtemplate", l, d);
            m = b.bc(c);
            a.$ActionMode & 1 && b.$AddEvent(c, "click", b.$CreateCallback(i, k, 0));
            a.$ActionMode & 2 && b.$AddEvent(c, "mouseover", b.cc(b.$CreateCallback(i, k, 1), c))
        }
        h.zc = function(b, d, f) {
            var a = p;
            p = b;
    ...
    j.$JssorCaptionSlideo$ = function(v, j, u) {
        ...
        function g(j, e, a) {
            ...
            if (f > 4)
                for (var k = c.ceil(f / 4), d = 0; d < k; d++) {
                    var h = e.slice(d * 4, c.min(d * 4 + 4, f))
                      , i = new m(h[0].Q,a || 0);
                    g(i, h, a);
                    j.gb(i, a)
                }
        ...
        g(e, o);
        var x = j.$Breaks || []
          , k = [].concat(x[b.ac(b.$AttributeEx(v, "b"))] || []);
        k.push({
            b: e.Eb(),
            d: k.length ? 0 : u
        });
