                ...
                <div class="orderBtnBox">
                    ...
                    <? if($st == 0){ ?>
                        <div class="orderBtn_default">
                            <a href="<?= $g_self_domain ?>/menpiao/ticket_order-<?= urlencode($db->to_gbk($obj['scenicInfo']['goodsName'])) ?>-<?= urlencode($db->to_gbk($ticketTypeName)) ?>--<?= $ticketType ?>-<?= $obj['scenicInfo']['goodsId'] ?>-<?= $obj['scenicInfo']['lvProductId'] ?>-<?= $values['lvGoodsId'] ?>.html"><button>再次预定</button></a>
                        </div>
                    <?}elseif($st == 1){?>
                        <!-- 出票成功按钮 -->
                        <div class="orderBtn_success">
                            <a href="<?= $g_self_domain ?>/menpiao/ticket_order-<?= urlencode($db->to_gbk($obj['scenicInfo']['goodsName'])) ?>-<?= urlencode($db->to_gbk($ticketTypeName)) ?>-<?= $values['isEmail'] ?>-<?= $ticketType ?>-<?= $obj['scenicInfo']['goodsId'] ?>-<?= $obj['scenicInfo']['lvProductId'] ?>-<?= $values['lvGoodsId'] ?>.html"><button>再次预定</button></a>
                    ...
                    <?}elseif($st == 3){?>
                        ...
                        <div class="orderBtn_chupiaozhong">
                            <a href="<?= $g_self_domain ?>/menpiao/ticket_order-<?= urlencode($db->to_gbk($obj['scenicInfo']['goodsName'])) ?>-<?= urlencode($db->to_gbk($ticketTypeName)) ?>-<?= $values['isEmail'] ?>-<?= $ticketType ?>-<?= $obj['scenicInfo']['goodsId'] ?>-<?= $obj['scenicInfo']['lvProductId'] ?>-<?= $values['lvGoodsId'] ?>.html"><button style="margin-left:360px;">再次预定</button></a>
                            <button class="applyRefundBtn">申请退款</button>
                        </div>
                        <!-- 已付款未使用 按钮 -->
