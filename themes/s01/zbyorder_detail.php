            ...
            <div class="orderInfo">
                ...
                <div class="orderInfo1">
                    <ul>
                        ...
                        <li class="sli">订单状态：<? echo $order_detail_data['orderStatusName']; if($order_detail_data['orderStatus'] == '2') echo '(出单中)'; if($order_detail_data['verifyFlag'] == '1') echo "<span style='color:red;'>订单审核失败；您的款项预计予3-5个工作日原路返还；</span>"; ?></li>
