		...
		<div id="top">
			<div class="topLeft">
				...
				<a href="" class="logo_text">
					<img src="/themes/s01/images/logowww_dz.png">
				</a>
			</div>
			<div class="topRight">
				...
				<div class="topAboveCont">
					...
					<div class="topAboveCont_left">
						...
						<span id="topAddress">
							...
							<a href="<?=$g_bus365_domain?>/city0" id="changeCity" style="color:#1ecd9d;">[切换]</a> -->
						</span>
					</div>
				</div>
		...
		<div id="nav">
			<div class="navLeft">
				<ul>
					...
					<li><a href="https://www.alitrip.com/jiudian/?spm=181.7091613.191938.6.sn8JQ5" target="_blank">酒店</a></li>
					<li><a href="<?=$g_bus365_domain?>/yongche">用车</a></li>
					<li><a href="<?=$g_bus365_domain?>/phone">手机版</a></li>
				</ul>
			</div>
			<div class="navRight">
				<div class="mybus365" style="position: relative;background-image:url(/themes/s01/images/xiala.png);background-repeat:no-repeat;background-position:125px center;">
					<a href="javascript:void(0)" id="mybus365_btn">我的Bus365</a>
					<? if($check != 'check'){ ?>
					...
					<ul class="before_login hide">
						<li>
							<a href="<?=$g_bus365_domain?>/index/order/orders/">我的订单</a>
						</li>
						<li>
							<a href="<?=$g_bus365_domain?>/index/order/orders/?status=topay
">待支付订单</a>
						</li>
						<li>
							<a href="<?=$g_bus365_domain?>/userinfo0">会员信息</a>
						</li>
						<li>
							<a href="<?=$g_bus365_domain?>/usersafe0">会员安全</a>
						</li>
						<li>
							<a href="<?=$g_bus365_domain?>/passenger/getPiList/0?page=1&size=5">常用乘车联系人管理</a>
						</li>
						<li>
							<a href="<?=$g_bus365_domain?>/coupon0">我的优惠券</a>
						</li>
						<li>
							<a href="<?=$g_bus365_domain?>/user/logout/">退出登录</a>
						</li>
					</ul>
					<?}?>
				</div>
