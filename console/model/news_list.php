...
if(req('kw')!=''){
	$qer .= " AND (a.`title` LIKE '%".req('kw')."%' )";
}

$sql = "SELECT a.*, b.cat_key, b.cat_name FROM t_article_thread a, t_article_catalog b WHERE 1=1 $qer AND a.site_id='$g_siteid' AND a.cat_id=b.cat_id ORDER BY thread_id DESC ";   
