...
$sql = "SELECT a.*,b.*,c.goods_name as shangpin FROM t_user_order a, t_refund_fee_apply b, t_user_order_item c WHERE c.order_code = a.order_code AND a.`site_id`='$g_siteid' AND a.`order_code`='$order_code' ";
