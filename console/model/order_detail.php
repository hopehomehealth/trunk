...
$sql = "SELECT a.*,c.lv_scenic_id FROM t_user_order a, t_shop b, t_goods_thread c WHERE a.shop_id=b.shop_id AND a.lv_product_id=c.lv_product_id AND a.`site_id`='$g_siteid' AND a.`order_code`='$order_code' ";
