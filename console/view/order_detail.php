        ...
        <td>
            <? if ($state == '1') { ?>
                <a href="do.php?cmd=order_close&order_code=<?= $detail['order_code'] ?>"
                   onclick="return confrim('确认取消订单吗？')" class="btn " target="_top" style="float:left;margin-right:10px">取消订单</a>
            <? } ?>
            ...
            <? if ($state == '5') { ?>
                <a href="do.php?cmd=order_delete&order_code=<?= $detail['order_code'] ?>"
                   onclick="return confrim('确认删除订单吗？')" class="btn " target="_top" style="float:left;margin-right:10px">删除订单</a>
            <? } ?>
        </td>
    </tr>
